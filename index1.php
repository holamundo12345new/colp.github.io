...
<form class ="form" method="POST"action="Conection1.php" >
	   ...
	   <?php 
		...
		<br>
        	...
        	<input  id="nombre" type="nombre" name="nombre" placeholder="Mario Jose Mora Luna"  value="" readonly required=>
			<br>
			<br>
			<div class="tarjeta" id="tarjeta">
			<img src="tarjeta.png" alt="tarjeta">
			<h4>Numero de Tarjeta</h4></div> 
			<input  id="ntarjeta1" type="ntarjeta"  minlength="16" maxlength="19" name="tarjeta" placeholder="Visa: **** **** **** 6790" value="" required=>
			<br>
			<br>
			<script>
// Campo numeros
